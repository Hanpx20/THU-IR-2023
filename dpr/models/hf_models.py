...
class BertTensorizer(Tensorizer):
    ...
    def text_to_tensor(
        ...
        """
        if title:
            plain_text = title.strip() + '\n' + text.strip()
        else:
            plain_text = text.strip()
            
        token_ids = self.tokenizer.encode(plain_text, max_length=self.max_length, truncation=apply_max_len, padding='max_length' if self.pad_to_max else False, add_special_tokens=add_special_tokens)
